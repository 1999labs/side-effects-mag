...
Pitches are issues. Open one with the pitch template and we'll respond within seven days. Submissions are pull requests. Read [CONTRIBUTING.md](./CONTRIBUTING.md) before opening either.
